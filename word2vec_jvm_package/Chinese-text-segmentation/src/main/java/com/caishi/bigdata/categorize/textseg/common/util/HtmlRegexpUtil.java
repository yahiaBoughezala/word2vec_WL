...
public class HtmlRegexpUtil {
    ...
    private final static String regxpForA = "<a([^>]*)>|</a([^>]*)>|<span([^>]*)>|</span([^>]*)>";
    ...
    private static Pattern origin2Pattern = Pattern.compile("\\s+(-)\\s+|\\s+(\\.)\\s+|\\s+(·)\\s+|\\s+(\\d+)\\s+||\\s+(\\d+:\\d+)\\s+||\\s+(\\d+-\\d+)\\s+");
    private static Pattern origin3Pattern = Pattern.compile("\\s*(\\d+)\\s+");
    ...
    public static String filterAllSpecialOrigin(String str){
    ...
    public static String filterA(String str) {
        Pattern pattern = Pattern.compile(regxpForA);
        Matcher matcher = pattern.matcher(str);
        StringBuffer sb = new StringBuffer();
        boolean result1 = matcher.find();
        while (result1) {
