...
hdfs dfs -rmr "hdfs://10.4.1.4:9000/news/w2v/sampling/${pt}"
hdfs dfs -mkdir -p "hdfs://10.4.1.4:9000/news/w2v/sampling/${pt}"
hdfs dfs -put -f ${outputFile}  "hdfs://10.4.1.4:9000/news/w2v/sampling/"
