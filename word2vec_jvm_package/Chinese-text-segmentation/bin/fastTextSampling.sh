#!/bin/bash
mainClass_SN="FastTextSampling"
mainCalls_QN="com.caishi.bigdata.categorize.textseg.common.main.FastTextSampling"
server_log_home="./logs"
server_name="FastTextSampling"
...
for num in ${arr_v[*]}; do
    ...
    outputFile=./data/fasttext_sampling/"$num-fasttext_sampling.text"
